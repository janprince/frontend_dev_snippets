 ...
 *  All the other code outside of the code block cannot access it. Block scope is built when you declare variables using let or const. 
...
// ======================= let ==========================
// the let variable can't be redeclared but can be reassigned;


// ====================== const ============================
// the const can be redeclared or reassigned
